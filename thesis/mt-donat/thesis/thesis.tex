\iffalse % TODO
approach should say
that it does not model the exact background workings of networks and transaction environments
e.g. communication, dentralization/decentralized etc
\fi
...
% thesis information
% -------------------------------------------------------------------
\title{Implementation of a Reputation Framework for Evaluation of Reputation Improvement Methods}                          % defines \thetitle
...
%\centerline{\includegraphics{pic/trust_network_josang.png}}
