...
% unused figures:
% figure~\ref{improvement_aging.pdf}
% figure~\ref{improvement_weights.pdf}
...
It is a sort of self-appraisal of those who provide content.
...
This method is irregular in how it interprets reviews.
Section~\ref{sec:approach_reviews} discussed previously how reviews are meant to give feedback on claims, not the claimer agents themselves.
...
Also, rating can use a mich larger amount of input data, including 
